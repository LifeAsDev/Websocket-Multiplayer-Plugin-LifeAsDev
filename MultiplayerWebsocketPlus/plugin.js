...
const PLUGIN_CLASS =
	(SDK.Plugins.Lifeasdev_MultiplayerWebsocketPlusPlugin = class MultiplayerWebsocketPlusPlugin extends (
		SDK.IPluginBase
	) {
		constructor() {
			super(PLUGIN_ID);
			...
			this._info.AddC3RuntimeScript("c3runtime/socketio-client.js");
